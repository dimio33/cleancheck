  ...
  return (
    <div className="flex-1 pb-24 max-w-lg mx-auto w-full">
      <div className="px-4 pt-6 pb-2">
        <h1 className="text-xl font-semibold text-stone-900 dark:text-stone-100">{t('trending.title')}</h1>
        <p className="text-sm text-stone-500 dark:text-stone-400 mt-1">{t('trending.desc')}</p>
      </div>
