...
export default function Home() {
 ...
 className="w-full pl-9 pr-4 h-11 rounded-xl bg-white shadow-sm text-sm text-stone-900 placeholder:text-stone-400 focus:outline-none focus:ring-2 focus:ring-teal-500/30 border border-stone-200/50"
 />
 </div>
 ...
 <motion.div
 className="mx-4 mb-4 p-4 bg-teal-50 rounded-2xl flex items-center gap-3"
 ...
 onChange={(e) => searchCity(e.target.value)}
 placeholder={t('home.searchCity')}
 className="w-full pl-9 pr-10 h-10 rounded-xl bg-white shadow-md text-sm text-stone-900 placeholder:text-stone-400 focus:outline-none focus:ring-2 focus:ring-teal-500/30 border border-stone-200/50"
 />
 {searchOverride && (
 <button
 onClick={resetToGps}
