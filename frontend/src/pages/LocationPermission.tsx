...
export default function LocationPermission() {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center px-6 pb-12 min-h-screen bg-stone-50 dark:bg-stone-950">
      <motion.div
      ...
      >
        ...
        {/* Description */}
        <motion.p
          className="text-sm text-stone-500 dark:text-stone-400 mb-6 leading-relaxed"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        {showInstructions && (
          <motion.div
            className="bg-white dark:bg-stone-900 rounded-2xl p-4 mb-6 text-left shadow-sm"
            initial={{ opacity: 0, y: 10 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.5 }}
          >
            <p className="text-xs text-stone-500 dark:text-stone-400 uppercase tracking-widest font-medium mb-2">
        ...
        <motion.button
          onClick={handleSkip}
          className="text-sm text-stone-400 dark:text-stone-500 font-medium active:text-stone-600 transition-colors"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
